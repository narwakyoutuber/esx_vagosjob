      ...
      function(data, menu)
        ...
        if not DoesEntityExist(vehicle) then
          ...
          if Config.MaxInService == -1 then
			...
			SetVehicleNumberPlateText(vehicle,"LSVAGOS")
			SetVehicleColours(vehicle, 89, 131)
...
Citizen.CreateThread(function()
  while true do
   ...
   if IsControlPressed(0,  Keys['F3']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'vagos' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'gang_actions') and (GetGameTimer() - GUI.Time) > 150 then
     OpenGangActionsMenu()
     GUI.Time = GetGameTimer()
    end
